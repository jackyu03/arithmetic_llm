...
python scripts/train/contrastive_sweep.py --instruction-corpus-path data/instruction_corpus.txt --tokenizer-path data/tokenizer_digit --foundational-checkpoint models/foundational/best_model.pt --eval --num-eval-samples 300 --contrastive-warmup-epochs-sweep 1 2 --contrastive-no-prop
